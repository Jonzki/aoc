...
namespace Aoc.Tests.Problems.Aoc19
{
    ...
    public class Problem7Tests
    {
        ...
        public void Part1_SmallInput_Is_Correct(string program, string phases, long output)
        {
            var result = Problem7.GetThrusterSignal(program, phases);
        ...
        public void Part2_SmallInput_Is_Correct(string program, string phases, long output)
        {
            var result = Problem7.GetThrusterSignal2(program, phases);
            Assert.AreEqual(output, result);
        }
    }
}