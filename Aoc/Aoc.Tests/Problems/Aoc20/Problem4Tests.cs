...
namespace Aoc.Tests.Problems.Aoc20
{
    ...
    public class Problem4Tests
    {
        ...
        public void SmallInput_Works_Part1(object input, object correctIsValid)
        {
            // Parse a passport.
            var passport = Problem4.ParsePassport((string)input);

            var isValid = Problem4.IsPasswordValid1(passport);

            Assert.AreEqual((bool)correctIsValid, isValid);
        }
        ...
        [DataRow("iyr:2010 hgt:158cm hcl:#b6652a ecl:blu byr:1944 eyr:2021 pid:093154719", true)]
        public void SmallInput_Works_Part2(object input, object correctIsValid)
        {
            // Parse a passport.
            var passport = Problem4.ParsePassport((string)input);

            var isValid = Problem4.IsPasswordValid2(passport);
